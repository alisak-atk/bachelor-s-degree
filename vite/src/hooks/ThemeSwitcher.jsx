...
const svgsun = `<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 457.32 457.32"><g id="XMLID_467_"><path fill="${encodeURIComponent(
    'black'
)}" d="M228.66,112.692c-63.945,0-115.968,52.022-115.968,115.967c0,63.945,52.023,115.968,115.968,115.968 s115.968-52.023,115.968-115.968C344.628,164.715,292.605,112.692,228.66,112.692z"/><path fill="${encodeURIComponent(
    'black'
...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
    ...
    '& .MuiSwitch-thumb': {
        ...
        '&::before': {
            ...
            backgroundImage: `url('data:image/svg+xml;utf8,${svgsun}')`,
        },
    },
    '& .MuiSwitch-track': {
        opacity: 1,
...
const ThemeSwitcher = ({ isDarkMode, onToggle }) => {
    return (
        ...
        <FormControlLabel
            control={<MaterialUISwitch sx={{ m: 1 }} checked={isDarkMode} onChange={onToggle} />}
            label=""
        />
