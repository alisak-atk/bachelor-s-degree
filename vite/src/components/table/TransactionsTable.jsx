...
const TransactionsTable = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await fetch(`${apiUrl}/transactions?role=${user.role}&id=${user.id}`, {
                    method: "GET",
                    credentials: "include",
                });
    ...
    const filteredData = data.filter(
        (item) =>
            ...
            item.receiverUsername.toLowerCase().includes(searchText.toLowerCase()) ||
    ...
    const columns = [
        ...
        { title: "ຊື່", dataIndex: "receiverUsername", key: "receiverUsername", className: "text-sm font-lao" },
        { title: "ຄົນໂດເນດ", dataIndex: "name", key: "name", className: "text-sm font-lao" },
        {
            title: "ຈຳນວນ",
            dataIndex: "amount",
            key: "amount",
